...
async function generateSmartQuestions(context, apiKey) {
 ...
 const prompt = `Given the following context: "${context}", generate 2-3 concise, basic relevant questions that a new teacher in the Science Department might ask based on this context. Do NOT suggest any questions about the Chairperson, the Managing director, the Principal and XLCRSCI-ArchGPT 1.0. Return only the questions as a plain list, one per line, with no extra text or numbering.`;
